...
const Hero = () => {
  ...
  // استخدم useMemo لتثبيت array وعدم تغييره على كل render
  ...
  }, [charIndex, isDeleting, titleIndex, titles]); // الآن titles ثابتة بسبب useMemo
          ...
          <div className="hero-image">
            <div className="image-container">
              ...
              <div className="image-placeholder">
                <img  
                  src={require('../../assets/images/meremoveback.png')}
                  alt="Ali Azzam" 
                />
              </div>
            </div>
